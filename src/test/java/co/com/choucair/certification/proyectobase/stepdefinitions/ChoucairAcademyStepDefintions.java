...
public void setStage() {
    ...
    @Given("^than JCAB wants to learn automation at the academy Choucair$")
    public void thanJCABWantsToLearnAutomationAtTheAcademyChoucair()  {
        OnStage.theActorCalled( "JCAB").wasAbleTo(OpenUp.thePage());
        OnStage.theActorCalled( "JCAB").wasAbleTo(Login.onThePage());
